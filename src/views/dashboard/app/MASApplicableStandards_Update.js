...
const UserProfile = () => {
    ...
    const deleteproduct = async (id) => {
        let result = await fetch(`https://hjhjkjkjkkjhjhi.herokuapp.com/MASapplicationStandard/${id} `, {
          method: "Delete",});
      ...
      const updateproduct = async ( ) => {
        console.warn(params);
    let result = await fetch(`https://hjhjkjkjkkjhjhi.herokuapp.com/MASapplicationStandard/${params.id}`);
    result = await result.json();
    setname( result.name );
      };
    ...
    const handleSubmit = async () => {
        const result = fetch(`https://hjhjkjkjkkjhjhi.herokuapp.com/MASapplicationStandard/${params.id}`, {
            method: "Put",
